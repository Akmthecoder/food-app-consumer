package com.android.foodieMart.services
...
import com.android.foodieMart.ui.HomeActivity
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun sendNotifcation(remoteMessage: RemoteMessage) {
        ...
        intent.putExtra(Constants.PURPOSE, Constants.MYORDERS)
        ...
        FirebaseMethods.singleValueEventChild(Connection.ORDERS, orderId.toString(),
