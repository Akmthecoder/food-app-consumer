...
import com.android.foodieMart.utils.CommonUtils.makeLinks
import com.android.foodieMart.utils.GenericTextWatcher
        ...
        FirebaseAuth.getInstance().signInWithCredential(credential)
            .addOnCompleteListener {
                if (it.isSuccessful) {
                    ...
                    Snackbar.make(
                        this, root,
                        it.exception?.message.toString(), Snackbar.LENGTH_LONG
                    ).show()
                }
            }
    }
